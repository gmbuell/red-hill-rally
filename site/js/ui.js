...
const RH = (() => {
  ...
  const dartUp = raw(`
    <path d="M27 31 C24.5 33.5 23.2 36.5 23 40 C25 38.2 26 37.6 27 37.2 Z" fill="#E31E24"/>
    <path d="M37 31 C39.5 33.5 40.8 36.5 41 40 C39 38.2 38 37.6 37 37.2 Z" fill="#E31E24"/>
    <path d="M32 8 C35.5 13 37 19 37 26 L37 36 L27 36 L27 26 C27 19 28.5 13 32 8 Z" fill="#000000"/>
    <circle cx="32" cy="20" r="3" fill="#FFFFFF"/>
    <g stroke-linecap="round">
      <path d="M32 40 L32 50" stroke="#E31E24" stroke-width="2.5"/>
      <path d="M27.5 39 L27.5 45.5" stroke="#000000" stroke-width="2"/>
      <path d="M36.5 39 L36.5 45.5" stroke="#000000" stroke-width="2"/>
    </g>`);
